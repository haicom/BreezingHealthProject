...
public class CaloricBurnHistoryActivity extends ActionBarActivity implements View.OnClickListener {
 private static final String TAG = "CaloricBurnHistoryActivity";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentFrame(R.layout.activity_burn_history);
        mContentResolver = getContentResolver();
        setActionBarTitle(R.string.energy_cost_history);
