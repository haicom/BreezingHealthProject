...
public class BLog {
    private static String debugTag = "BreezingHealth";
    ...
    public static String getDebugTag() {
        return BLog.debugTag;
    }

    public static void setDebugTag(final String debugTag) {
        BLog.debugTag = debugTag;
    }

    public static DebugLevel getDebugLevel() {
        return BLog.debugLevel;
    }
    ...
    public static void setDebugLevel(final DebugLevel debugLevel) {
        ...
        BLog.debugLevel = debugLevel;
    }

    public static void v(final String message) {
        BLog.v(debugTag, message);
    }
    ...
    public static void d(final String message) {
        BLog.d(debugTag, message, null);
    }

    public static void d(final String message, final Throwable throwable) {
        BLog.d(debugTag, message, throwable);
    }

    public static void d(final String tag, final String message) {
        BLog.d(tag, message, null);
    }
    ...
    public static void i(final String message) {
        BLog.i(debugTag, message, null);
    }

    public static void i(final String message, final Throwable throwable) {
        BLog.i(debugTag, message, throwable);
    }

    public static void i(final String tag, final String message) {
        BLog.i(tag, message, null);
    }
    ...
    public static void w(final String message) {
        BLog.w(debugTag, message, null);
    }

    public static void w(final Throwable throwable) {
        BLog.w(debugTag, "", throwable);
    }

    public static void w(final String tag, final String message) {
        BLog.w(tag, message, null);
    }
    ...
    public static void e(final String message) {
        BLog.e(debugTag, message, null);
    }

    public static void e(final Throwable throwable) {
        BLog.e(debugTag, "", throwable);
    }

    public static void e(final String tag, final String message) {
        BLog.e(tag, message, null);
    }
