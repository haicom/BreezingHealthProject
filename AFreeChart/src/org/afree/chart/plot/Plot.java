...
public abstract class Plot implements AxisChangeListener, LegendItemSource, Cloneable, Serializable,DatasetChangeListener, MarkerChangeListener {
    ...
    public static final PaintType DEFAULT_OUTLINE_PAINT_TYPE = new SolidColor(Color.TRANSPARENT);
    ...
    public static final PaintType DEFAULT_BACKGROUND_PAINT_TYPE = new SolidColor(Color.TRANSPARENT);
