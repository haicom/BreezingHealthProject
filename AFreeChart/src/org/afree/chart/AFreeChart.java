...
public class AFreeChart implements Drawable, TitleChangeListener,
    ...
    public static final PaintType DEFAULT_BACKGROUND_PAINT = new SolidColor(Color.TRANSPARENT);
    ...
    public AFreeChart(String title, Font titleFont, Plot plot,
        ...
        this.borderStroke = 2;
        this.borderPaintType = new SolidColor(Color.TRANSPARENT);
        ...
        if (createLegend) {
            ...
            PaintType paintType = new SolidColor(Color.TRANSPARENT);
